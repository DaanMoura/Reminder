...
class HomeViewController: UIViewController {
  ...
  private func checkForExistingData() {
    if let userName = UserDefaultsManager.loadUserName() {
      ...
      self.contentView.nameTextField.placeholder =
        "home.name.placeholder".localized
    }
...
extension HomeViewController: HomeViewDelegate {
  func didTapLogoutButton() {
    ...
    UserDefaultsManager.removeOnboardingSeen()
  ...
  func didTapFeedbackButton() {
    if let url = URL(string: "https://github.com/DaanMoura/Reminder"),
